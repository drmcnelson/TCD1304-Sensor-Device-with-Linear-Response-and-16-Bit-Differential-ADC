...
This directory contains an Arduino sketch file and libraries to operate the TCD1304 Sensor using the Teensy 4 in either (a) the two board system, the TCD1304 SPI board plus Teensy 4 Controller Rev 3 or (b) the All-In-One board with FlexPWM support.

Features in this implementation include ring buffering, and cnvst idling to keep the ADC and its voltage reference in a ready steady state.
...
The file TCD1304Device2b.h  is a header only library for the TCD1304 using the NXP iMXRT1060 FlexPWM.

The file TCD1304Device_Controller_250213.ino  implements the user command interface and instantiates the ring buffer system.
