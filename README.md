...
Following is an example of a single frame and the result of adding 100 frames at the same signal intensity.  The signal noise ratio increases by a factor of 10 as expected (√N).  Aside, being able to add data frames and obtain meaningful data is possible only when your instrument is linear.  We will discuss this in further detail in the next section.
